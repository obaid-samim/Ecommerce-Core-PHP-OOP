...
<html lang="zxx">
<head>
	<title>The Canada - Shop</title>
	<meta charset="UTF-8">
	<meta name="description" content="The CanadaShop eCommerce">
		...
		<div class="container-fluid">
			...
			<div class="header-right">
				...
				<div class="dropdown" style="float:right;">
				  <button class="btn btn-outline-primary"><i class=""></i>My Account</button>
				  <div class="dropdown-content">
				  <a href="#">Your Account</a>
				 <a href="#">Your Order</a> 
				 <a href="#">Whitelist</a> 
				 <hr>
				 <a href="#">If New User</a> 
				 <a href="#">Login</a> 
				 <a href="#">Register</a> 
				  </div>
				</div>
